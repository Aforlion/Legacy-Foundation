...
export const TiktokIcon: React.FC<IconProps> = ({ size = 18, ...props }) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    width={size}
    height={size}
...
export const ThreadsIcon: React.FC<IconProps> = ({ size = 18, ...props }) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    width={size}
    height={size}
    ...
    {...props}
  >
    <path d="M12 2a10 10 0 1 0 10 10C22 7.03 18.25 5 12 5c-4.14 0-7 2.46-7 7s2.86 7 7 7c2.51 0 4.29-.93 4.88-2M12 8a4 4 0 1 1-4 4 4.005 4.005 0 0 1 4-4z" />
  </svg>
);
